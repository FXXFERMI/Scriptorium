                    ...
                    {[
                        {
                            ...
                            imgSrc: "/images/suhani-photo.jpg",
                            linkedIn: "https://www.linkedin.com/in/suhanip/",
                        },
                        {
                            name: "Siqi (Fermi) Fei",
                            role: "Founder & Developer & Designer",
                            imgSrc: "/images/siqi-photo.jpg",
                            linkedIn: "https://www.linkedin.com/in/siqi-fermi-fei/",
                        },
                        {
                            name: "Joyce Ang",
                            role: "Founder & Developer & Designer",
                            imgSrc: "/images/joyce-photo.jpg",
                            linkedIn: "https://www.linkedin.com/in/joyce-yy-ang/",
                        },
                    ].map((member, index) => (
                        <div key={index} className="flex flex-col items-center text-center">
                            ...
                            />
                            <h3 className={`text-lg font-semibold text-${theme === 'dark' ? 'white' : 'black'}`}>{member.name}</h3>
                            <p className={`text-${theme === 'dark' ? 'gray-300' : 'gray-600'} text-md mb-2`}>{member.role}</p>
                            <a
