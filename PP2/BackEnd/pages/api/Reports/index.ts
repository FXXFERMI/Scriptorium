...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  if (req.method === "POST") {
    ...
    const { reportId, uid, bid, commentId, replyId, page = 1, limit = 10 } = req.query as {reportId?: string, uid?: string, bid?: string, commentId?: string, replyId?: string, page: string, limit: string};
